...
([§FS-rhei-states.3.3](../functional-spec/rhei-states.spec.md#33-terminal-result), [§FS-rhei-transition-cmd.3.2](../functional-spec/rhei-transition-cmd.spec.md#32-terminal-result-on-entry)). Point 1 is what remains
genuinely `rhei complete`'s own ([§FS-rhei-complete.4.1](../functional-spec/rhei-complete.spec.md#41-completion-target-selection)). The "Decision" text is
