...
#### Subtask 1.1: Define Agent enum and InstallSkills clap struct
**State:** `completed`
...
#### Subtask 1.2: Wire command dispatch
**State:** `completed`
...
#### Subtask 2.1: Implement binary-relative resolution
**State:** `completed`
...
#### Subtask 2.2: Implement dev-build fallback
**State:** `completed`
...
#### Subtask 3.1: Implement marker-based walk
**State:** `completed`
...
#### Subtask 3.2: Handle fallback to cwd
**State:** `completed`
...
#### Subtask 4.1: Implement copy operation
**State:** `completed`
...
#### Subtask 4.2: Implement symlink operation
**State:** `completed`
...
#### Subtask 4.3: Implement dry-run mode
**State:** `completed`
...
#### Subtask 5.1: Implement marker injection
**State:** `completed`
...
#### Subtask 5.2: Implement marker removal
**State:** `completed`
...
#### Subtask 6.2: Check marker-based agents
**State:** `completed`
...
#### Subtask 7.1: Install skill directories
**State:** `completed`
...
#### Subtask 7.2: Generate and inject registration block
**State:** `completed`
...
#### Subtask 8.1: Implement MDC format conversion
**State:** `completed`
...
#### Subtask 9.1: Implement shared rules-directory handler
**State:** `completed`
...
#### Subtask 9.2: Wire Kilocode, Pi, and Antigravity
**State:** `completed`
...
#### Subtask 10.1: Implement Windsurf handler
**State:** `completed`
...
#### Subtask 10.2: Implement Copilot handler
**State:** `completed`
...
#### Subtask 11.1: Uninstall file-based agents
**State:** `completed`
...
#### Subtask 11.2: Uninstall marker sections
**State:** `completed`
...
#### Subtask 12.2: Implement formatted output
**State:** `completed`
...
#### Subtask 13.1: Test global install with copy (default)
**State:** `completed`
...
#### Subtask 13.2: Test local install
**State:** `completed`
