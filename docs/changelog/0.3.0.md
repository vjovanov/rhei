...
- Give a cold invocation the project's **mid-term memory**. Under `rhei run`
  ...
  **`### Leaving a trail`**, what a result file and a task body are worth to
  ...
  rather than repeated. [§FS-rhei-memory](../functional-spec/rhei-memory.spec.md#fs-rhei-memory-mid-term-memory)
  ...
  ignored. [§FS-rhei-plan-language.3.8](../functional-spec/rhei-plan-language.spec.md#38-result-block-consistency)
  ...
  its section is. [§FS-rhei-memory.5](../functional-spec/rhei-memory.spec.md#5-surfaces)
  ...
  fence. [§FS-rhei-memory.4.5](../functional-spec/rhei-memory.spec.md#45-fencing-and-rendering)
  ...
  [§FS-rhei-memory.4.2](../functional-spec/rhei-memory.spec.md#42-position)
  ...
  [§FS-rhei-plan-language.3.6](../functional-spec/rhei-plan-language.spec.md#36-link-integrity) (PR #89)
...
- `rhei templates --json` now carries the **whole** input schema for every
  ...
  ([§FS-rhei-templates.6.3.1](../functional-spec/rhei-templates.spec.md#631-the-json-entry-carries-the-whole-input-schema)). This is what another program needs to build an
...
- Add `rhei new`, so the first rhei and every ticket after it can be created
  ...
  *ticket* selector: the earlier sketch of `rhei new "Billing" --under auth`
  ...
  project directory's immediate children. [§FS-rhei-new](../functional-spec/rhei-new.spec.md#fs-rhei-new-rhei-new) [§FS-rhei-panta.2](../functional-spec/rhei-panta.spec.md#2-default-home-for-new-rheis) (PR #88)
...
- Give a parent a way to look after its subtree *while* it runs instead of only
  ...
  **brief** at `runtime/supervise/<task-id>.md` (or
  ...
  names the state that skips it. [§FS-rhei-states.1.4](../functional-spec/rhei-states.spec.md#14-reserved-state-names)
  ...
  agent and no credentials. [§FS-rhei-supervision](../functional-spec/rhei-supervision.spec.md#fs-rhei-supervision-subtree-supervision-specification) [§DF-subtree-supervision](../decisions/functional/subtree-supervision.md#df-subtree-supervision-a-supervisor-is-a-barrier-over-its-subtree-woken-after-the-fact)
  Issue #86. PR #87 [§FS-rhei-supervision](../functional-spec/rhei-supervision.spec.md#fs-rhei-supervision-subtree-supervision-specification) [§DF-subtree-supervision](../decisions/functional/subtree-supervision.md#df-subtree-supervision-a-supervisor-is-a-barrier-over-its-subtree-woken-after-the-fact)
...
- A new built-in template, **`supervised-delivery`**, is the workflow
  ...
  **plan exports** (`**Provides:**` / `**Consumes:**`), each one file holding a
  ...
  `examples/supervised-delivery-example/`. [§FS-rhei-supervision](../functional-spec/rhei-supervision.spec.md#fs-rhei-supervision-subtree-supervision-specification) [§FS-rhei-templates](../functional-spec/rhei-templates.spec.md#fs-rhei-templates-rhei-templates-specification)
  PR #87 [§FS-rhei-templates](../functional-spec/rhei-templates.spec.md#fs-rhei-templates-rhei-templates-specification)
...
- `rhei instantiate`'s template environment documents `range()`, arithmetic, and
  ...
  [§FS-rhei-templates.5](../functional-spec/rhei-templates.spec.md#5-instantiation-template-syntax)
  PR #87 [§FS-rhei-templates.5](../functional-spec/rhei-templates.spec.md#5-instantiation-template-syntax)
