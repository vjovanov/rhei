...
- Separate a run from the surface that watches it. `rhei run` bound the two into
  ...
  **`rhei run --json`** is a third frontend beside the TUI and plain stdout: one
  ...
  Issue #82. PR #83 [§FS-rhei-run-headless](../functional-spec/rhei-run-headless.spec.md#fs-rhei-run-headless-detached-runs) [§FS-rhei-run-json](../functional-spec/rhei-run-json.spec.md#fs-rhei-run-json-rhei-run---json) [§DA-detached-runs](../decisions/architectural/detached-runs.md#da-detached-runs-a-detached-run-is-a-supervisor-process-not-a-daemon-service)
  [§FS-rhei-run.2.7](../functional-spec/rhei-run.spec.md#27-run-identity) [§FS-rhei-run-tui.1.4](../functional-spec/rhei-run-tui.spec.md#14-frontend-selection)
...
- Fix the minor release assembling its release commit from a path list that had
  ...
  bump rather than a dry run later. PR #85 [§FS-rhei-distribution.2](../functional-spec/rhei-distribution.spec.md#2-version-source)
...
- Fix the waits reporting a run that exited 0 as one that "recorded no exit
  ...
  reported as one that recorded nothing. PR #84 [§FS-rhei-run-headless.5.3](../functional-spec/rhei-run-headless.spec.md#53---json)

- The 500-line file-size rule is now a gate rather than a table. It has been
  [§AR-source-file-size.1](../architecture/source-file-size.spec.md#1-file-size-policy) since it was written — 500 soft, 2000 hard, spec files
  ...
  Issue #80. PR #81 [§AR-source-file-size.1](../architecture/source-file-size.spec.md#1-file-size-policy) [§AR-source-file-size.2](../architecture/source-file-size.spec.md#2-large-file-register)
...
- Give `rhei run` real ownership of the subprocesses it starts. Agents and
  ...
  **`SIGINT`, `SIGTERM`, and `SIGHUP` now interrupt the run** instead of
  ...
  no longer reads as an unexplained failure. Issue #53. PR #77 [§FS-rhei-run.3.2](../functional-spec/rhei-run.spec.md#32-interruption-and-process-ownership) [§FS-rhei-run-tui.1.8](../functional-spec/rhei-run-tui.spec.md#18-failure-modes)
  [§DA-supervised-process-groups](../decisions/architectural/supervised-process-groups.md#da-supervised-process-groups-subprocesses-are-supervised-process-groups-with-one-termination-path)
...
- Publish the plan-model crate as `rhei-plan` rather than `rhei-plan-core`.
  ...
  [§FS-rhei-distribution.1](../functional-spec/rhei-distribution.spec.md#1-release-targets)
...
- Build release binaries with Rust 1.95.0 instead of the 1.82.0 MSRV
  ...
  PR #79 [§FS-rhei-distribution.4](../functional-spec/rhei-distribution.spec.md#4-pgo-binary-builds)
...
- Install the CLI under a short `rh` alias alongside `rhei`. `cargo install
  ...
  both binaries link. PR #78 [§FS-rhei-distribution.1](../functional-spec/rhei-distribution.spec.md#1-release-targets)
- **Publish two crates instead of eight.** A release now ships only
  ...
  PR #78 [§FS-rhei-distribution.1](../functional-spec/rhei-distribution.spec.md#1-release-targets)
- Fix crates.io publishing, which could not have completed as written:
  ...
  published set. PR #78 [§FS-rhei-distribution.1](../functional-spec/rhei-distribution.spec.md#1-release-targets)
...
- Fix the release version bump, which skipped `xtask/Cargo.toml`. Its exact
  ...
  [§FS-rhei-distribution.2](../functional-spec/rhei-distribution.spec.md#2-version-source)
- Make the result obligation a property of the terminal state, not of `rhei
  ...
  **Breaking:** a `rhei transition` or a `rhei run` that lands a ticket in a
  ...
  [§FS-rhei-states.3.3](../functional-spec/rhei-states.spec.md#33-terminal-result) [§FS-rhei-transition-cmd.3.2](../functional-spec/rhei-transition-cmd.spec.md#32-terminal-result-on-entry) [§FS-rhei-complete.4](../functional-spec/rhei-complete.spec.md#4-behavior)
  [§FS-rhei-run.3](../functional-spec/rhei-run.spec.md#3-execution-loop) [§FS-rhei-run-report.3.1](../functional-spec/rhei-run-report.spec.md#31-layout) [§FS-rhei-run-tui.1.5.5](../functional-spec/rhei-run-tui.spec.md#155-live-actions-intervene-and-human-gate)
  [§FS-rhei-agents.3](../functional-spec/rhei-agents.spec.md#3-prompt-composition) [§FS-rhei-agents.3.2](../functional-spec/rhei-agents.spec.md#32-completion-condition) [§FS-rhei-agents.4](../functional-spec/rhei-agents.spec.md#4-environment-variables) [§FS-rhei-programs.2](../functional-spec/rhei-programs.spec.md#2-environment-variables)
  [§FS-rhei-plan-language.3.10](../functional-spec/rhei-plan-language.spec.md#310-state-artifact-contracts) [§FS-rhei-viz.5.1](../functional-spec/rhei-viz.spec.md#51-human-gate-transitions)
...
- Treat a non-leaf task as a task. It has its own state, its own journey, and
  ...
  [§FS-rhei-plan-language.3](../functional-spec/rhei-plan-language.spec.md#3-semantic-constraints) [§FS-rhei-next.3](../functional-spec/rhei-next.spec.md#3-default-behavior-claim-mode) [§FS-rhei-next.3.4](../functional-spec/rhei-next.spec.md#34-claiming-a-non-leaf-ticket-with---task)
  [§FS-rhei-transition-cmd.3.1](../functional-spec/rhei-transition-cmd.spec.md#31-descendants-first-on-terminal-entry) [§FS-rhei-run.3](../functional-spec/rhei-run.spec.md#3-execution-loop) [§FS-rhei-list](../functional-spec/rhei-list.spec.md#fs-rhei-list-rhei-list)
...
- Show why a task is parked. A state that declares no artifacts of its own —
  ...
  [§FS-rhei-viz.4](../functional-spec/rhei-viz.spec.md#4-surroundings-inspector) [§FS-rhei-run-tui.1.5.3](../functional-spec/rhei-run-tui.spec.md#153-flow-view-default)
...
- Name the resolved path when required outputs are missing, and fix the
  ...
  [§FS-rhei-agents.3.2.1](../functional-spec/rhei-agents.spec.md#321-runtime-semantics) [§FS-rhei-states.4.1](../functional-spec/rhei-states.spec.md#41-variable-namespace) [§FS-rhei-states.4.2](../functional-spec/rhei-states.spec.md#42-resolution-rules)
- Give every failing `rhei` command a next action. Errors now carry a `help:`
  ...
  [§FS-rhei-errors.1](../functional-spec/rhei-errors.spec.md#1-anatomy-of-an-error) [§FS-rhei-errors.2](../functional-spec/rhei-errors.spec.md#2-copy-paste-safety) [§FS-rhei-errors.3.1](../functional-spec/rhei-errors.spec.md#31-execution-target-inputs) [§FS-rhei-errors.4](../functional-spec/rhei-errors.spec.md#4-paths-in-errors)
  [§FS-rhei-errors.5](../functional-spec/rhei-errors.spec.md#5-machine-readable-errors) [§FS-rhei-errors.6](../functional-spec/rhei-errors.spec.md#6-coverage) [§FS-rhei-templates.3.1](../functional-spec/rhei-templates.spec.md#31-validation-rules)
- Fix three ways a state handoff could go missing or take the run down with it.
  ...
  [§FS-rhei-states.3.2](../functional-spec/rhei-states.spec.md#32-state-handoffs) [§FS-rhei-run.3](../functional-spec/rhei-run.spec.md#3-execution-loop)
- Hand work product between tasks with `**Provides:**` and `**Consumes:**`. A
  ...
  PR #49 [§FS-rhei-plan-language.3.12](../functional-spec/rhei-plan-language.spec.md#312-task-exports) [§FS-rhei-agents.3](../functional-spec/rhei-agents.spec.md#3-prompt-composition)
...
- Measure Pi token usage. Pi was listed as an accounting-supported agent but
  ...
  JSONL stays in the agent log. PR #51 [§FS-rhei-cost-accounting.4](../functional-spec/rhei-cost-accounting.spec.md#4-extraction-flow)
...
- Compile the skills into the binary, so `rhei install-skills` works from an
  ...
  [§FS-rhei-install-skills.4.3](../functional-spec/rhei-install-skills.spec.md#43-resolve-skill-source) [§FS-rhei-install-skills.4.4](../functional-spec/rhei-install-skills.spec.md#44-symlink-vs-copy)
- Stop `install-skills` from deleting the lines after its own block in
  ...
  alone. [§FS-rhei-install-skills.4.5](../functional-spec/rhei-install-skills.spec.md#45-registration)
- Install `rhei-template-writer` by default. The skill shipped in the repo but
  ...
  [§FS-rhei-install-skills.2](../functional-spec/rhei-install-skills.spec.md#2-options)
...
- Make the state machine a property of the rhei, defaulted by the project.
  ...
  [§DA-per-rhei-state-machines](../decisions/architectural/per-rhei-state-machines.md#da-per-rhei-state-machines-the-state-machine-is-a-per-rhei-property-defaulted-by-the-manifest) [§FS-rhei-panta.6](../functional-spec/rhei-panta.spec.md#6-project-scope-and-command-behavior) [§AR-rhei-panta.4](../architecture/rhei-panta.spec.md#4-state-machine-binding)
- Validate the node-kind keyword on `**Prior:**` references. The parser
  ...
  [§FS-rhei-plan-language.3.1](../functional-spec/rhei-plan-language.spec.md#31-dependency-integrity)
- Let `rhei complete` take the ticket id positionally. Every ticket surface
  ...
  meaning for scripts. [§FS-rhei-complete.2.1](../functional-spec/rhei-complete.spec.md#21-ticket-targets)
...
- Put the init agent-discovery note where the repository's agent reads. In a
  ...
  the target. [§FS-rhei-init.4](../functional-spec/rhei-init.spec.md#4-agent-discovery-note-agentsmd)
- Say when a standalone workspace lands as tracked repository content. The
  ...
  legitimate use. [§FS-rhei-templates.6.2](../functional-spec/rhei-templates.spec.md#62-instantiating-inside-a-panta-project)
- Answer `rhei templates <name>` with the template. Naming a template after
  ...
  [§FS-rhei-templates.6.3](../functional-spec/rhei-templates.spec.md#63-rhei-templates)
- Render instantiation-report paths relative to the working directory. The
  ...
  working directory stay absolute. [§FS-rhei-templates.6.1.3](../functional-spec/rhei-templates.spec.md#613-instantiation-summary-output)
- Name the rhei id in merged-project render headings. A plan titled
  ...
  title already names the id. [§FS-rhei-render.3.4](../functional-spec/rhei-render.spec.md#34-rendering-a-merged-project)
- Make `rhei instantiate` reckon with the Panta project it is standing in. Run
  ...
  ([§FS-rhei-panta.6](../functional-spec/rhei-panta.spec.md#6-project-scope-and-command-behavior)) *every* project-scoped command then failed to load, while
  ...
  rather than silently unlisted. [§FS-rhei-templates.6.2](../functional-spec/rhei-templates.spec.md#62-instantiating-inside-a-panta-project)
- Hoist a template's bundled `settings.json` to the project it joins. Settings
  ...
  [§FS-rhei-templates.4](../functional-spec/rhei-templates.spec.md#4-template-shipped-settings) [§FS-rhei-agents.1.1](../functional-spec/rhei-agents.spec.md#11-global-and-project-settings)
- Stop `rhei reset` from destroying runtime state on an unattended invocation.
  ...
  must pass `-y`. [§FS-rhei-reset.1.2](../functional-spec/rhei-reset.spec.md#12-confirmation)
- Let `rhei list` survive a malformed plan. One unparseable `*.rhei.md` failed
  ...
  because a partial graph cannot decide readiness. [§FS-rhei-panta.6](../functional-spec/rhei-panta.spec.md#6-project-scope-and-command-behavior)
- Anchor the `AGENTS.md` agent-discovery note at the repository root. Written
  ...
  that nothing was found above it. [§FS-rhei-init.4](../functional-spec/rhei-init.spec.md#4-agent-discovery-note-agentsmd) [§FS-rhei-panta.6](../functional-spec/rhei-panta.spec.md#6-project-scope-and-command-behavior)
...
- Report every missing template input at once, name `--list-inputs`, and stop
  ...
  `(type, default=…)` parenthetical. [§FS-rhei-templates.6.1.1](../functional-spec/rhei-templates.spec.md#611-input-ux)
...
- Finish the renamed-ticket hint. It named the `mv` for the result artifact but
  ...
  both halves. [§FS-rhei-complete](../functional-spec/rhei-complete.spec.md#fs-rhei-complete-rhei-complete)
...
- Ship a built-in template library inside the binary. `rhei templates` printed
  ...
  same name still shadows one. [§FS-rhei-templates.1](../functional-spec/rhei-templates.spec.md#1-template-discovery)
- Add `rhei release`, the counterpart to the claim `rhei next` writes. A worker
  ...
  `--task <id>` or `--all`, and has `--dry-run`. [§FS-rhei-release](../functional-spec/rhei-release.spec.md#fs-rhei-release-rhei-release)
- Render `rhei viz` for a Panta project as one merged graph. It drew a separate,
  ...
  priors so an edge is scoped rather than erased. [§FS-rhei-viz.7.3](../functional-spec/rhei-viz.spec.md#73-panta-projects-render-as-one-graph)
...
- Report a `**Prior:**` under the id the author wrote. An unresolvable dotted
  ...
  longer suggest a task as its own prior. [§AR-rhei-panta.3](../architecture/rhei-panta.spec.md#3-identity-and-id-namespacing) [§FS-rhei-validate.4.1](../functional-spec/rhei-validate.spec.md#41-unresolved-prior-references)
- Report every parse problem in a file when it is reached through its project.
  ...
  [§FS-rhei-validate.4.2](../functional-spec/rhei-validate.spec.md#42-diagnostic-parity-across-scopes)
- Group project-scoped `rhei render` output by rhei. Both text formats printed
  ...
  the completion summary it is named for. [§FS-rhei-render.3.3](../functional-spec/rhei-render.spec.md#33-progress) [§FS-rhei-render.3.4](../functional-spec/rhei-render.spec.md#34-rendering-a-merged-project)
- Exclude parent tickets from `rhei list --ready`. `--ready` listed epics that
  ...
  the listing overstated the available work. [§FS-rhei-list.3.1](../functional-spec/rhei-list.spec.md#31-what---ready-means)
- Name the fix in the unknown-node-kind error. It reported the declared kinds
  ...
  to write. [§FS-rhei-plan-language.3](../functional-spec/rhei-plan-language.spec.md#3-semantic-constraints)
...
- Distinguish ticket depth from project level in the plan language spec.
  ...
  [§FS-rhei-plan-language.3](../functional-spec/rhei-plan-language.spec.md#3-semantic-constraints)
- Let basin tickets execute. `rhei validate` and `rhei list` accepted them
  ...
  `index.panta.md` under their project-qualified ids. [§FS-rhei-panta.6.1](../functional-spec/rhei-panta.spec.md#61-readiness-and-rhei-next)
- Resolve the plan's own state machine in `rhei states`. It was the only
  ...
  [§FS-rhei-states-cmd.3](../functional-spec/rhei-states-cmd.spec.md#3-behavior)
...
- Reject an unrecognized `**Field:**` in a task's metadata block instead of
  ...
  [§FS-rhei-plan-language.2](../functional-spec/rhei-plan-language.spec.md#2-grammar-ebnf)
- Keep line numbers and code frames on parse errors inside a project. The same
  ...
  `rhei init` steers new authors toward. [§FS-rhei-panta.6](../functional-spec/rhei-panta.spec.md#6-project-scope-and-command-behavior)
...
- Refuse to complete a ticket whose `**Prior:**` dependencies are unsatisfied,
  ...
  [§FS-rhei-complete.4](../functional-spec/rhei-complete.spec.md#4-behavior) [§FS-rhei-validate.4](../functional-spec/rhei-validate.spec.md#4-behavior) [§FS-rhei-transition-cmd.3](../functional-spec/rhei-transition-cmd.spec.md#3-behavior)
- Fail loudly on an authored `index.rhei.md` under `basin/` instead of skipping
  ...
  [§AR-rhei-panta.1](../architecture/rhei-panta.spec.md#1-on-disk-layout)
- Treat a workspace rhei with no task files as a valid, empty rhei rather than
  ...
  [§FS-rhei-plan-language.1.2](../functional-spec/rhei-plan-language.spec.md#12-directory-workspace-agent-teams-high-concurrency)
- Report manual-only tickets from `rhei run --dry-run` instead of aborting on
  ...
  still exiting non-zero. [§FS-rhei-run.4](../functional-spec/rhei-run.spec.md#4-dry-run)
- Accept a bare task id in `**Prior:**` (`**Prior:** auth.2`) alongside the
  ...
  what was written. [§FS-rhei-plan-language.5](../functional-spec/rhei-plan-language.spec.md#5-ast-node-types)
...
- Name the host files `rhei init` writes or changes outside the project it
  ...
  discovers weeks later that no plan was ever committed. [§FS-rhei-init.5](../functional-spec/rhei-init.spec.md#5-discovery-report)
- Render `rhei viz`'s not-Panta-aware caveat into the generated page, naming
  ...
  [§FS-rhei-viz.7.3](../functional-spec/rhei-viz.spec.md#73-panta-projects-render-as-one-graph)
...
- Start every generated completion script with a comment header that shows how
  ...
  directive stays on the first line. PR #61 [§FS-rhei-completions.5](../functional-spec/rhei-completions.spec.md#5-output-contract)
...
- Make the shell argument to `rhei completions` optional: detect it from
  ...
  error. PR #58 [§FS-rhei-completions.2](../functional-spec/rhei-completions.spec.md#2-arguments)
...
- Add `rhei init [DIR]`: set up a Panta project in a gitignored `panta/`
  ...
  orchestration is never started by an agent. PR #54 [§FS-rhei-init](../functional-spec/rhei-init.spec.md#fs-rhei-init-rhei-init)
  [§FS-rhei-panta.6](../functional-spec/rhei-panta.spec.md#6-project-scope-and-command-behavior)
- Treat an empty Panta project — the state `rhei init` leaves — as valid:
  ...
  never silently invisible behind a green validation. PR #54 [§FS-rhei-panta.6](../functional-spec/rhei-panta.spec.md#6-project-scope-and-command-behavior)
...
- Make Panta the default execution model: a bare rhei — a `.rhei.md` file or a
  ...
  [§AR-rhei-panta.2](../architecture/rhei-panta.spec.md#2-load-model) [§AR-rhei-panta.3](../architecture/rhei-panta.spec.md#3-identity-and-id-namespacing)
- Mutate project-wide. `rhei run`, `next`, `transition`, `complete`, and `reset`
  ...
  file. [§FS-rhei-panta.6](../functional-spec/rhei-panta.spec.md#6-project-scope-and-command-behavior) [§FS-rhei-run.2.5](../functional-spec/rhei-run.spec.md#25-project-scope---rhei) [§FS-rhei-run.2.6](../functional-spec/rhei-run.spec.md#26-run-lock)
- Accept rhei-local shorthand for CLI ticket targets: `rhei complete 1` resolves
  ...
  candidates when more than one does. [§FS-rhei-panta.6](../functional-spec/rhei-panta.spec.md#6-project-scope-and-command-behavior)
- Add `--rhei <id>` (repeatable) to narrow `run`, `next`, `reset`, and `list` to
  ...
  [§FS-rhei-panta.6](../functional-spec/rhei-panta.spec.md#6-project-scope-and-command-behavior) [§FS-rhei-panta.6.1](../functional-spec/rhei-panta.spec.md#61-readiness-and-rhei-next) [§FS-rhei-panta.6.4](../functional-spec/rhei-panta.spec.md#64-reset-validate-list-viz) [§FS-rhei-run.2.5](../functional-spec/rhei-run.spec.md#25-project-scope---rhei)
  [§FS-rhei-next.2.2](../functional-spec/rhei-next.spec.md#22-project-scope---rhei) [§FS-rhei-list.2](../functional-spec/rhei-list.spec.md#2-options) [§FS-rhei-reset.1.1](../functional-spec/rhei-reset.spec.md#11-options)
- Scope a narrowed `rhei reset` to everything keyed by an in-scope ticket —
  ...
  [§FS-rhei-reset.2.1](../functional-spec/rhei-reset.spec.md#21-narrowed-reset---rhei) [§FS-rhei-panta.6.4](../functional-spec/rhei-panta.spec.md#64-reset-validate-list-viz)
- Validate result links as a pair: link text and target must describe the same
  ticket, both qualified or both rhei-local. [§FS-rhei-panta.6.3](../functional-spec/rhei-panta.spec.md#63-completion-and-rollup)
  [§FS-rhei-plan-language.3.8](../functional-spec/rhei-plan-language.spec.md#38-result-block-consistency)
- Warn when `rhei viz` is pointed at a Panta project: it is not Panta-aware, so
  ...
  graph. [§FS-rhei-viz.7.3](../functional-spec/rhei-viz.spec.md#73-panta-projects-render-as-one-graph)
- Unify subprocess ids: `RHEI_TASK_ID` is the project-qualified ticket id for
  ...
  gains `task.localId`. [§FS-rhei-panta.6](../functional-spec/rhei-panta.spec.md#6-project-scope-and-command-behavior) [§AR-rhei-panta.3](../architecture/rhei-panta.spec.md#3-identity-and-id-namespacing)
  ...
  **Upgrading a pre-qualification workspace.** Nothing is rewritten for you;
  ...
  - *Completed plans.* Legacy rhei-local result links keep validating and are
    ...
    qualified form. [§FS-rhei-panta.6.3](../functional-spec/rhei-panta.spec.md#63-completion-and-rollup)
- Add durable task state history to Flow/dashboard and the `rhei run` TUI,
  ...
  shared chrome. PR #48 [§FS-rhei-viz.4](../functional-spec/rhei-viz.spec.md#4-surroundings-inspector) [§FS-rhei-run-tui.1.5](../functional-spec/rhei-run-tui.spec.md#15-tui-surface)
- Add Codex token accounting from `turn.completed` JSON usage, persisted runtime
  ...
  report, and `rhei cost`. PR #44 [§FS-rhei-cost-accounting.1](../functional-spec/rhei-cost-accounting.spec.md#1-mental-model)
  [§FS-rhei-cost-accounting.2](../functional-spec/rhei-cost-accounting.spec.md#2-runtime-files) [§FS-rhei-cost-accounting.4](../functional-spec/rhei-cost-accounting.spec.md#4-extraction-flow)
- Add reusable state prompt templates loaded from sibling
  ...
  starts. PR #46 [§FS-rhei-states.4.4](../functional-spec/rhei-states.spec.md#44-prompt-templates)
- Run program states in the same live `--parallel` worker pool as agent states,
  ...
  continues to be scheduled. PR #43 [§FS-rhei-run.5](../functional-spec/rhei-run.spec.md#5-parallel-execution) [§FS-rhei-programs.6.3](../functional-spec/rhei-programs.spec.md#63-parallel-mode)
- Add the Flow-style interactive `rhei run` TUI surface with shared Flow, Machine,
  ...
  callback runs. PR #42 [§FS-rhei-run-tui.1.5](../functional-spec/rhei-run-tui.spec.md#15-tui-surface) [§FS-rhei-run-tui.1.5.2](../functional-spec/rhei-run-tui.spec.md#152-navigation-selection-and-keys)
- Write a durable per-run Markdown report at the end of every `rhei run` to
  ...
  PR #41 [§FS-rhei-run-report.1](../functional-spec/rhei-run-report.spec.md#1-report-artifact) [§FS-rhei-run-report.4](../functional-spec/rhei-run-report.spec.md#4-transition-ledger)
- Add task-level execution overrides with `**Model:**` and `**Target:**`,
  ...
  and canonical example coverage. PR #40 [§FS-rhei-plan-language.3.11](../functional-spec/rhei-plan-language.spec.md#311-task-execution-overrides)
- Print a console-first end-of-run summary when `rhei run` exits on an
  ...
  unchanged so scripts and CI keep matching it. PR #39 [§FS-rhei-run-report.3](../functional-spec/rhei-run-report.spec.md#3-end-of-run-console-summary)
