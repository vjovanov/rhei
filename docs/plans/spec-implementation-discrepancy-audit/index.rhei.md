# Rhei: Spec Implementation Discrepancy Audit
**States:** spec-implementation-discrepancy-audit

## Context

Audit the written Rhei specifications against the current implementation. The
workspace is partitioned so multiple agents can independently scope, compare,
elaborate, and propose reconciliation for different spec areas before a human
chooses the final reconciliation outcome.
