...
run_claude_review() {
    ...
    claude -p \
        ...
        "$(review_prompt "$model")" > "$output_path"
}
...
# ---------------------------------------------------------------------------
# consolidate: called once after all model reviews are written.
# Merges findings and appends verification tasks to the workspace.
# ---------------------------------------------------------------------------
consolidate() {
