...
For concrete authoring examples, inspect [minimal-plan.rhei.md](references/examples/minimal-plan.rhei.md) and the [directory-workspace](references/examples/directory-workspace/index.rhei.md) example.
